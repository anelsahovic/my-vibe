...
export default function EventEditForm({ event }: Props) {
  ...
  const [selectedStartDate, setSelectedStartDate] = useState(event?.startDate);
  const [selectedEndDate, setSelectedEndDate] = useState(event?.endDate);
  const [isOnlineEvent, setIsOnlineEvent] = useState(event?.isOnline);
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  defaultValue={event.price as number}
                  placeholder="100"
                  className="pr-12"
                />
